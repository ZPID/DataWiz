...
public class RecordDTO extends SPSSFileDTO implements Serializable {
	...
	public String toString() {
		return "RecordDTO [id=" + id + ", studyId=" + studyId + ", recordName=" + recordName + ", created=" + created + ", createdBy=" + createdBy
		    + ", description=" + description + ", fileName=" + fileName + ", versionId=" + versionId + ", changeLog=" + changeLog + ", changed=" + changed
		    + ", changedBy=" + changedBy + ", masterRecord=" + masterRecord + ", originalName=" + originalName + ", minioName=" + minioName + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((minioName == null) ? 0 : minioName.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (masterRecord != other.masterRecord)
			return false;
		if (minioName == null) {
			if (other.minioName != null)
				return false;
		} else if (!minioName.equals(other.minioName))
			return false;
