            ...
            <ul>
                <c:choose>
                    <c:when test="${localeCode eq 'de'}">
                        ...
                        <li><a href="${locale_url_de}" class="active">DE<span style="display: none"
                                                                              itemprop="inLanguage">German</span></a>
                        </li>
                        <li><a href="${locale_url_en}">EN<span style="display: none"
                                                               itemprop="inLanguage">English</span></a>
                        </li>
                    </c:when>
                    <c:when test="${localeCode eq 'en'}">
                        <li id="lp_ms_header_1_contact"><a href="mailto://datawiz@zpid.de">Contact</a></li>
                        <li><a href="${locale_url_de}">DE<span style="display: none" itemprop="inLanguage">German</span></a>
                        </li>
                        <li><a href="${locale_url_en}" class="active">EN<span style="display: none"
                                                                              itemprop="inLanguage">English</span></a>
                        </li>
                    </c:when>
                </c:choose>
        ...
        <div class="lp_ms_header_row" id="lp_ms_header_2">
            <div id="lp_ms_header_2_image">
                <div id="lp_ms_header_2_logo">
                    <div id="lp_ms_header_2_logo_img" itemprop="name">
                        <a href="/DataWiz/"><span id="lp_ms_header_2_logo_bold">Data</span><span
                                id="lp_ms_header_2_logo_thin">Wiz</span></a>
                    </div>
                </div>
            </div>
        </div>
