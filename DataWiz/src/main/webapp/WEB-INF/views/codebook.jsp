            ...
            <table class="table table-striped table-bordered scrollTable">
              <thead>
                <tr>
                  ...
                  <th class="th-width-30" onclick="$('.codebookTableHide').toggle();">...</th>
              ...
              <tbody>
                <c:forEach items="${StudyForm.record.variables}" var="var" varStatus="loop">
                  <tr>
                    ...
                    <td class="codebookTableHide th-width-100 hidefirst"><s:message code="spss.role.${var.role}" /></td>
                    ...
                    <td class="th-width-200"><c:forEach items="${var.dw_attributes}" var="val" varStatus="attloop">
                    ...
                    <td class="th-width-300"><c:forEach items="${var.dw_attributes}" var="val" varStatus="attloop">
                        <c:if test="${val.label == 'dw_itemtext'}">
                          <sf:textarea class="form-control"
                            path="record.variables[${loop.count-1}].dw_attributes[${attloop.count-1}].value" />
                        </c:if>
                      </c:forEach></td>
                    <td class="th-width-100"><c:forEach items="${var.dw_attributes}" var="val" varStatus="attloop">
