          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <ul class="list-group">
                  ...
                  <c:if
                    ...
                    <li class="list-group-item"><sf:label path="delMail">
                      ...
                      <div class="row">
                        <div class="col-md-3">
                          <sf:select path="newRole.userId" class="form-control" id="accessMailChange"
                                     onchange="showHideNewRole();">
                            <sf:option value="0">
                        ...
                        <div class="col-md-3">
                          <sf:select path="newRole.type" class="form-control" id="accessChangeSel"
                                     onchange="showHideNewRole();">
                            <sf:option value="0">
                              <s:message code="gen.select"/>
                            </sf:option>
                ...
                <s:message code="roles.edit.role.help" var="appresmess"/>
                    ...
                    <div class="col-md-12 col-xs-12">
                      <div class="col-md-6 col-xs-12">
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-btn"> <sf:button class="btn btn-success" type="submit"
                                                                    name="addUser">
                      ...
                      <s:message code="roles.add.user.help" var="appresmess"/>
                      <%@ include
                          file="templates/helpblock.jsp" %>
                    </div>
                  </div>
                </div>
              </div>
