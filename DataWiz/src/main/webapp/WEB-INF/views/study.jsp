...
<div id="mainWrapper">
    <div class="content-container">
        ...
        <div class="content-padding">
                ...
                <c:otherwise>
                    <div class="row text-align-right btn-line">
                        ...
                        principal.user.hasRole('DS_WRITER', StudyForm.study.id, true)}">
                                <c:set var="allowEdit" value="true"/>
                                <c:url var="accessUrl"
                                       value="/project/${StudyForm.project.id}/study/${StudyForm.study.id}/switchEditMode?_s=${StudyForm.study.id}"/>
                                <c:choose>
            ...
            <!-- Submenu -->
            <c:if test="${!hideMenu}">
                <ul class="nav nav-tabs subnavtop" data-spy="affix" data-offset-top="400" style="cursor: pointer;">
                    <li role="presentation" id="basisDataActiveClick" class="studyContentClick">
                        <a><s:message code="study.submenu.basic.data"/></a>
                    </li>
                    <c:if test="${not empty StudyForm.study.id}">
                        <li role="presentation" id="designActiveClick" class="studyContentClick">
                            <a><s:message code="study.submenu.design"/></a>
                        </li>
                        <li role="presentation" id="sampleActiveClick" class="studyContentClick">
                            <a><s:message code="study.submenu.sample"/></a>
                        </li>
                        <li role="presentation" id="surveyActiveClick" class="studyContentClick">
                            <a><s:message code="study.submenu.survey"/></a>
                        </li>
                        <li role="presentation" id="ethicalActiveClick" class="studyContentClick">
                            <a><s:message code="study.submenu.ethical"/></a>
                        </li>
                    </c:if>
                </ul>
            </c:if>
            <c:url var="accessUrl" value="/project/${StudyForm.project.id}/study/${StudyForm.study.id}?_s=${StudyForm.study.id}"/>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <c:url var="accessUrl" value="/project/${StudyForm.project.id}/study/${StudyForm.study.id}/deleteStudy?_s=${StudyForm.study.id}"/>
                <a href="${accessUrl}" class="btn btn-warning btn-sm" id="deleteBTN" onclick="return checkDeletePhrase('${deletePhrase}')">
                    <s:message code="study.delete.modal.final.del"/>
                </a>
            </div>
        </div>
    </div>
...
<div id="duplicateModal" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        <!-- Modal content-->
        <c:url var="accessUrl" value="/project/${StudyForm.project.id}/study/${StudyForm.study.id}/duplicate?_s=${StudyForm.study.id}"/>
