                            ...
                            <div class="form-group">
                                <div class="col-sm-12" style="background-color: #eeeeee;">
                                    ...
                                    <table class="display table table-striped table-bordered table table-condensed matrixtable margin-bottom-0"
                                        ...
                                        <thead>
                                        <tr>
                                            <c:forEach items="${StudyForm.importMatrix[0]}" var="row"
                                                       varStatus="rowNum">
                            ...
                            <div class="col-sm-12">
                                                    ...
                                                    <div class="pre-xy-scrollable">
                                                        <table class="table table-striped table-bordered margin-bottom-0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="12"><strong><s:message
                                                                        code="warning.var.added"/></strong></td>
                                                                </c:when>
                                                                <c:otherwise>
                                                                <c:choose>
                                                                <c:when test="${not empty var.type}">
                                                                    <c:set var="currVAR" value="${var}"
                                                                           scope="request"/>
                                                            ...
                                                            <tr class="warning">
                                                                <td colspan="12"><strong><s:message
                                                                        code="warning.var.removed"
                                                                        arguments="${var.name},${var.type}"/></strong>
                                                                </td>
                                                            </tr>
                                                            </c:when>
                                                            <c:otherwise>
                                                            ...
                                                            <tr>
                                                                <c:choose>
                                                                    <c:when test="${not empty var.type}">
                                                                        <td colspan="18"><sf:checkbox
                                                                                path="compList[${loop.count-1}].keepExpMeta"
                                                                                label="Erweitere Metadaten übernehmen: "/>
                                                                            <s:message
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <select style="display: inline-block; width: 26%;" class="form-control input-sm"
                                                id="actCodeBookEntreeNum">
                                    ...
                                    <div class="col-sm-4 text-align-right">
                                        ...
                                        <input style="display: inline-block; width: 26%;" type="text"
                                               class="form-control input-sm" id="actCodeBookPage"/>
                                    ...
                                    <div class="col-sm-5 text-align-right">
                                        <ul class="pagination marginTop0">
                                            ...
                                            <li class="active"><a class="codeBookPagerItems" id="pagerCodebookAct">0</a>
                                            </li>
