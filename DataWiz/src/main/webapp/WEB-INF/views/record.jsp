...
<div id="mainWrapper">
    <div class="content-container">
        ...
        <div class="content-padding">
            ...
            <%--@elvariable id="StudyForm" type="de.zpid.datawiz.form.StudyForm"--%>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <a href="<c:url value="/project/${StudyForm.project.id}/study/${StudyForm.study.id}/records" />"
                           class="btn btn-default btn-sm"><s:message
            ...
            <div class="modal-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><b><s:message code="record.export.modal.csv"/></b>
                        <ul class="list-group">
                            <li class="list-group-item btn btn-default btn-sm" onclick="window.open('${exportUrl}/export/CSVMatrix', '_blank')"
                                data-dismiss="modal"><s:message
                            ...
                            <li class="list-group-item btn btn-default btn-sm" onclick="window.open('${exportUrl}/export/CSVZIP', '_blank')"
                                data-dismiss="modal"><s:message
                    ...
                    <li class="list-group-item"><b><s:message code="record.export.modal.spss"/></b>
                        <ul class="list-group">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="list-group-item btn btn-default btn-sm" onclick="window.open('${exportUrl}/export/SPSS', '_blank')"
                                        data-dismiss="modal"><s:message
                    ...
                    <li class="list-group-item"><b><s:message code="record.export.modal.json"/></b>
                        <ul class="list-group">
                            <li class="list-group-item btn btn-default btn-sm" onclick="window.open('${exportUrl}/export/JSON', '_blank')" data-dismiss="modal">
                                <s:message
                    ...
                    <li class="list-group-item"><b><s:message code="record.export.modal.pdf"/></b>
                        ...
                        <s:message code="record.export.modal.pdf.help" var="appresmess"/>
                        <%@ include file="templates/helpblock.jsp" %>
                    </li>
                </ul>
            </div>
