...
function createStudyLinkList(data, project, study) {
    ...
    var link_study = '<a href="' + link_pre + '?_s=' + study.id + '">' + data.linkStudy + '</a>';
    var link_records = '<a href="' + link_pre + '/records?_s=' + study.id + '">' + data.linkRecords + '</a>';
    var link_studmat = '<a href="' + link_pre + '/material?_s=' + study.id + '">' + data.linkStudMat + '</a>';
